Pod::Spec.new do |s|
  ...
  s.homepage     = 'http://git.yunchejinrong.com/yunche-ios-thirdLib/SSZipArchive'
  s.license      = { :type => 'MIT', :file => 'LICENSE.txt' }
  s.authors      = { 'Sam Soffes' => 'sam@soff.es', 'Joshua Hudson' => nil, 'Antoine Cœur' => nil }
  s.source       = { :git => 'http://git.yunchejinrong.com/yunche-ios-thirdLib/SSZipArchive.git', :tag => "#{s.version}" }
